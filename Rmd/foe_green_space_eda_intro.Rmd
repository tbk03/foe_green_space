...
```{r garden_summary_stats_by_rating}
...
* Thinking back to the rule of thumb derived from the Essex Design Guide that 50 m^2^ garden area per capita might be considered a minimum. The median garden area per capita is above this figure for all rating groups execept rating group A. 
