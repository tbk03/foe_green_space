...
As part of the research underpinning the Green Space Gap report, Friends of the Earth have developed a new approach for classifying the extent to which neighborhoods (or Middle Super Output Areas in the terminology of the administrative geography) across England experience green space deprivation. Neighborhoods are classified into five groups; with group A including the least green space deprived neighborhoods, and E including the most green space deprived. This classification is primarily based on analysis of [two datasets from the ONS](https://www.ons.gov.uk/economy/environmentalaccounts/datasets/accesstogardensandpublicgreenspaceingreatbritain) detailing: (1) the amount garden space; and, (2) the accessibility of public green spaces (parks etc.).

![image caption](../images/202010109_data_structure.jpg)

In the report, Friends of the Earth also draw on the ONS Index of Multiple Deprivation (IMD) dataset to explore the relationship between green space deprivation and demographic factors including ethnicity and income.
...
## Structure for Exploratory Data Analysis
...
```{r, fig.width = 12.5, fig.height=7, eval=FALSE}
