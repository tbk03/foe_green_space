---
title: "Friends of the Earth Green Space Data: Exploratory Data Analysis 1"
output: 
  html_document:
    df_print: paged
...
### Writing and analysis approach

This notebook contains an exploratory data analysis. The focus was on quickly exploring the data at hand to develop insights and a result:

-   Where the exploratory analysis didn't turn up any interesting findings I made sparse (if any) notes.

-   The visualizations are fairly basic in places, they tend to be more developed where in parallel with the EDA I was trying to learn more about a specific package (e.g. the graphical grammar of tables) and/or visualisation approach.

### The status of the notebook

-   In the process of writing I archived some chunks of code towards the end of the notebook. These chunks related to questions that I was no longer interested and the code is not currently executable.
...
+================================================+================================+==================================================================+===================================================================================================================+
| (FOE) Green Space Consolidated Data -          | green_space                    |                                                                  | [Friends of the Earth](https://friendsoftheearth.uk/nature/green-space-consolidated-data-england)                 |
|                                                |                                |                                                                  |                                                                                                                   |
| England - Version 2.1.xlsx                     |                                |                                                                  |                                                                                                                   |
+------------------------------------------------+--------------------------------+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+
| Local_Authority_District_to_Region             | LAD_to_region                  | Using the December 2019 version                                  | [ons](https://geoportal.statistics.gov.uk/datasets/3ba3daf9278f47daba0f561889c3521a_0)                            |
|                                                |                                |                                                                  |                                                                                                                   |
| \_\_December_2019\_\_Lookup_in_England.csv     |                                |                                                                  |                                                                                                                   |
+------------------------------------------------+--------------------------------+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+
| Rural_Urban_Classification\_(2001)\_for_MSOAs  | urban_rural\_                  | Using the 2001 version of the data (the most recently available) | [ons](https://geoportal.statistics.gov.uk/datasets/rural-urban-classification-2001-of-msoas-in-england-and-wales) |
|                                                |                                |                                                                  |                                                                                                                   |
| \_in_England_and_Wales/RUC_MSOA_2001_EW_LU.csv | classification                 |                                                                  |                                                                                                                   |
+------------------------------------------------+--------------------------------+------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------+
...
```{r, eval=FALSE, fig.width = 12.5, fig.height=7}
