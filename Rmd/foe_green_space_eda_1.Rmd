...
data_points_subset <- data_points %>% 
  select(green_space_area_per_capita,
         garden_area_per_capita,
         morphology_code) %>%
  filter(green_space_area_per_capita > 0) %>% 
  mutate(log_green_space_area_per_capita = log(green_space_area_per_capita)) %>% 
  select(-green_space_area_per_capita)
...
p1 <- ggplot(data = assignments %>% 
             ...
             mapping = aes(x = log_green_space_area_per_capita,
                           y = garden_area_per_capita)
             )
