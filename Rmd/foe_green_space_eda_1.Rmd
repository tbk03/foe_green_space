...
p + geom_point(mapping = aes(x = log(green_space_area)),
               alpha = 0.5) +
  labs(colour = "GS rating")
```
```{r}
...
p + geom_point(mapping = aes(x = population_imd,
                             y = log(green_space_area_per_capita)), 
               alpha = 0.5) +
  labs(colour = "GS rating")
```
```{r}
p <- ggplot(data = green_space,
            mapping = aes(x = green_space_area))
```
