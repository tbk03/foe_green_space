...
```{r}
run_kmeans_exploratory_workflow <- function(km_in, k_max, public_gs_vars, garden_vars){
  
  kmeans_outputs <- run_n_kmeans(n = k_max, km_in = km_in)
...
public_gs_vars <- c("norm_log_green_space_area_per_capita",
                    "norm_sqrt_pcnt_pop_with_go_space_access")

garden_vars <- c("norm_log_ave_gar_size",
                 "norm_to_power_six_perc_add_with_gar")

run_kmeans_exploratory_workflow(kmeans_in_norm, public_gs_vars, garden_vars, k_max = 5)
...
run_kmeans_exploratory_workflow(kmeans_in_scale, public_gs_vars_scale, garden_vars_scale, k_max = 5)
```
