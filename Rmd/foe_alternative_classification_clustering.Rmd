...
# exploratory_workflow_scale_out <- run_kmeans_exploratory_workflow(kmeans_in_scale, public_gs_vars_scale, garden_vars_scale, k_max = 9)
```
...
```{r}
plotting_df_clusters <- gs_gar_norm_clusters %>% 
  filter(k == 5) %>% 
  select(msoa_code, msoa_name,
         perc_add_with_gar, ave_gar_size,
